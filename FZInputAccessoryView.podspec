#
#  Be sure to run `pod spec lint FZInputAccessoryView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "吴福增" => "wufuzeng_lucky@sina.com" }
  # Or just: s.author    = "吴福增"
  # s.authors            = { "吴福增" => "wufuzeng_lucky@sina.com" }
  # s.social_media_url   = "http://twitter.com/吴福增"
  ...
  s.source_files  = "Source/Classes", "Source/Classes/**/*.{h,m}"
